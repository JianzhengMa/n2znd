...
#
# usage python wigner.py [-n <NUMBER>] [-t <TEMPERATURE>] <MOLDEN-FILE> -x

# wigner.py takes exactly one command-line argument (the input file with the frequencies and normal modes), plus
...
# distribution of that state is employed. 
